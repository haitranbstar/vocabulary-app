    ...
    return (
      <div className="min-h-screen p-6 md:p-12 flex items-center justify-center">
        <div className="glass-card p-8 text-center max-w-md w-full">
          ...
          <p className="text-gray-400 mb-6">Bài tập tổng hợp ngữ pháp</p>
            ...
            {isLoading ? (
              <>
                ...
                <h2 className="text-xl font-bold text-white mb-2">
                  Đang tạo bài tập tổng hợp...
                </h2>
                <p className="text-gray-400">
                  AI đang sinh 20 câu trắc nghiệm từ tất cả các thì
                </p>
              </>
            ) : (
              <>
                <Shuffle size={48} className="mx-auto text-accent mb-4" />
                <h2 className="text-2xl font-bold text-white mb-2">
                  Bài Tập Tổng Hợp
                </h2>
                <p className="text-gray-400 mb-2">
                  20 câu trắc nghiệm ngẫu nhiên từ 5 thì:
                </p>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="glass-card p-6 mb-6">
          {currentQuestion.tense && (
            <span className="inline-block px-2 py-1 bg-accent/15 text-accent rounded-md text-xs font-medium mb-3">
              {currentQuestion.tense}
            </span>
          )}
